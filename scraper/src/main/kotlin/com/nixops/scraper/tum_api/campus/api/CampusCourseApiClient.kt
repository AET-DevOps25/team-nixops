...
class CampusCourseApiClient(
    ...
    fun getCourses(
        ...
        do {
            val urlBuilder = ("$baseUrl/courses").toHttpUrlOrNull()?.newBuilder()
                ?: throw IllegalArgumentException("Invalid base URL")

            val filterValue = "courseNormKey-eq=LVEAB;curriculumVersionId-eq=$curriculumVersionId;orgId-eq=1;termId-eq=$termId"
